<template>
  <section class="page">
    <div class="container">
      <h1>Trabalhos de Conclusão de Curso (TCCs)</h1>
      <p class="subtitle">
        Projetos acadêmicos desenvolvidos durante minha formação técnica e superior.
      </p>
      ...
      <h3>❓ Qual foi o desafio do Projeto Integrador I?</h3>
        ...
        <h4>🧠 O que foi desenvolvido neste projeto?</h4>
        <p> Neste projeto foi realizado o planejamento completo da infraestrutura de TI de uma empresa do setor editorial e gráfico, com foco em organização, padronização e viabilidade técnica.</p>
        <p>As principais atividades desenvolvidas incluíram:</p>
        <ul>
          <li>Levantamento organizacional e mapeamento dos setores da empresa</li>
          <li>Dimensionamento das estações de trabalho por setor</li>
          <li>Definição de configurações de hardware conforme a função operacional</li>
          <li>Seleção e justificativa de sistemas operacionais e softwares utilizados</li>
          <li>Planejamento de proteção elétrica e continuidade de energia</li>
          <li>Estimativa de custos de equipamentos, licenças e serviços</li>
          <li>Consolidação da proposta em documentação técnica e apresentação final</li>
        </ul>
        <!-- <hr /> -->
      ...
      <!-- <div class="card" style="margin-top: 48px;"> -->
        ...
        <!-- <h3>❓ Qual é o foco do TCC em ADS?</h3> -->
        <!-- <p> -->
          <!-- Aplicar conceitos de análise de sistemas, arquitetura de software e -->
          <!-- desenvolvimento, consolidando a formação acadêmica. -->
        <!-- </p> -->
